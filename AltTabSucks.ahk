...
#Include *i lib\SC.ahk ; SC automation (scoped to SC window) — optional

A_TrayMenu.Insert("1&", "Settings", (*) => ShowSettingsGui())
A_TrayMenu.Insert("2&", "Hotkey Reference", (*) => ShowTextGui("Hotkey Reference", _BuildHotkeyRef(), 1250, 45))
A_TrayMenu.Insert("3&")